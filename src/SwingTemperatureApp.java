...
public class SwingTemperatureApp extends JFrame{ 
    ...
    public SwingTemperatureApp(){
        ...
        // Add Components 
        //Add label for the Celsius text field 
        add(new JLabel("Celsius:")); 
        //Create andd add the Celsius text field 
        celsiusField = new JTextField(); 
        add(celsiusField); 
        //Add lable for the Fahrenheit text field 
        add(new JLabel("Fahrenheit:")); 
        //Create and add the Fahrenheit text field 
        fahrenheitField = new JTextField(); 
        add(fahrenheitField);
                //Convert buttons 
 
        //Create button to convert Celsius to Fahrenheit 
